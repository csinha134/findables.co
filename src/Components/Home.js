    ...
    <>
      ...
      <div data-aos="fade-right" className="main">
        ...
        <div className="demo_video">
          <h6 className="section-heading">Detailed Explanation 💻</h6>
          <iframe width="1060" height="515" src="https://www.youtube.com/embed/HGuq2pWwWAM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
...
<div data-aos="fade-right">
      ...
      <div className="footer">
        ...
        <h5 style={{ textAlign: "center", color:"white"}}>
          Copyright © 2022 findables.co . All rights reserved.
        </h5>
      </div>
      {/* <div className="About">
        <div>
