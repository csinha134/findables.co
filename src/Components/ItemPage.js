        ...
        validation.push(
          <div>
            {current_user === "true" ? (
              <div>
                <div>
                  <h1 className="attributes">Your Question :</h1>
                  <h5 style={{color:"white"}}>{data.question}</h5>
                </div>

                <div>
                  <h1 className="attributes">Answers Submitted :</h1>
                  {answers.length === 0 ? (
                    <h3 style={{color:"white"}}>No Answers Yet.</h3>
                  ) : (
